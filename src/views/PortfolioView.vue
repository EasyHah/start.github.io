                ...
                items: [
                    {
                        id: 1,
                        name: '步道游览介绍',
                        imageUrl: 'img/portfolio-budao.png',
                        status: '这是上方山步道植物的介绍网站',
                        github: 'https://github.com/EasyHah/aspirin.github.io',
                        demo: 'https://easyhah.github.io/aspirin.github.io/'
                    },
                    {
                        id: 2,
                        name: '实习过程介绍（未完成）',
                        imageUrl: 'img/portfolio-homepage.png',
                        status: '实习过程主页 展示的小组风貌.',
