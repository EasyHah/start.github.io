<template>
    <main
        ...
        <div class="space-y-2 text-center md:text-left px-10">
            <p class="text-amber-200">Hello World, 我们是</p>
            <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">阿司匹林</h1>
            <div class="py-2">
                <h1
            ...
            <p class="text-white pr-4 fade-in-from-left">Welcome to Our website. <span class="wave">👋🏼</span>
            </p>
            <br>

        </div>
        <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high"
...
<script>
    export default {
        ...
        data() {
            return {
                toRotate: ["GNSS第四小队", "易爆易红温", "一群山里灵活的狗"],
                period: 2000,
                txt: '',
                loopNum: 0,
                isDeleting: false,
